...
#ifndef _H4VECTOR_HPP_
#define _H4VECTOR_HPP_

#include "../H4_Core.hpp"
#include "../H4_Base.hpp"
#include "../H4_Allocator.hpp"
...
{
#pragma pack(push, 1)
	// * a vector following the H4 format
	template<typename _Elem>
	struct H4Vector : H4Allocator
	{
	protected:
		BOOL _init; // useless
		...
		VOID Deallocate();
	public:
		H4Vector(const int number_elements);
		H4Vector();
		~H4Vector();
...
#ifdef _H4_STD_CONVERSIONS_
		H4Vector(const std::vector<_Elem>& vec);
		std::vector<_Elem> to_std_vector() const;
		H4Vector<_Elem>& operator=(const std::vector<_Elem>& vec);
#endif /* _H4_STD_CONVERSIONS_ */
	};
#pragma pack(pop)
}

#endif /* #define _H4VECTOR_HPP_ */